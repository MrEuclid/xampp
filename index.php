                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-100 text-gray-600 text-xs uppercase tracking-wider">
                            ...
                            <th class="py-3 px-6 border-b">Class</th>
...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-6xl mx-auto px-4 py-10 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- READ Card -->
            <a href="ajax/read.php" class="group block bg-white rounded-2xl p-6 border-t-4 border-pioGreen-600 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between mb-4">
